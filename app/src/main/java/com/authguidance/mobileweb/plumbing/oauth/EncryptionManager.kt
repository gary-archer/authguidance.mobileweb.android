...
class EncryptionManager(val context: Context) {
    ...
    private fun loadSymmetricKeyPair(): SecretKey {
        ...
        throw RuntimeException("Unable to load the symmetric key named $SYMMETRIC_KEY_ALIAS")
    }
    ...
    fun decrypt(encryptedData: String): String {
        ...
        if (parts.size != 2) {
            throw RuntimeException("Invalid encrypted data was encountered in EncryptionManager")
        }
